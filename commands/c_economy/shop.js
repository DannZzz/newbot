...
module.exports = {
  ...
  run: async (bot, message, args) => {
      ...
      .addFields(
        {name: `<a:vip1:867868958877810748> VIP 1 - 750 ${STAR}`,
        value: `\`\`?купить [vip-1 или VIP-1]\`\`\nДаёт иммунитет к команду **?воровать**, а так же увеличивает ставку для всех игр(до 1.000.000), доступ к командам - эмбед, канал, уровни, эскиз и био профиля, и так же увеличивает стоимость рыб(на 33%).`,
        inline: false},
        {name: `<a:vip2:867868958459166751> VIP 2 - 3.000 ${STAR}`,
